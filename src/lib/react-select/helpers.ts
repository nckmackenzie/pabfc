 ...
 */
const controlStyles = {
  base: 'flex !min-h-10 w-full rounded-md border border-input dark:bg-input/30! bg-transparent! pl-3 py-1 pr-1 gap-1 text-sm  transition-colors hover:cursor-pointer',
...
const dropdownIndicatorStyles = 'p-1 rounded-md opacity-50'
const menuStyles =
