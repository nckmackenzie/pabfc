...
import { PAYROLL_REPORT_CARDS } from "@/features/reports/lib/constants";
...
export const Route = createFileRoute("/app/reports/payroll/")({
	...
	head: () => ({
		meta: [{ title: "Payroll Reports / Prime Age Beauty & Fitness Center" }],
	}),
});
	...
	return (
		<div className="space-y-6">
			<PageHeader
				...
				description="Select a payroll report to view annual payroll reporting data."
			/>
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
				{PAYROLL_REPORT_CARDS.map((card) => (
					<ReportCard
						key={card.to}
						title={card.title}
