...
import { getBalanceSheetDrillDown } from "@/features/reports/services/balance-sheet.api";
import { currencyFormatter, dateFormat, toNumber } from "@/lib/helpers";
import { toTitleCase } from "@/lib/utils";

type DrillDownItem = Awaited<ReturnType<typeof getBalanceSheetDrillDown>>[number];
...
export function BalanceSheetDrillDown({ id, asOfDate }: { id: number; asOfDate: string }) {
...
function DrilldownTable({
	...
	const { data } = useSuspenseQuery({
		queryKey: ["balance-sheet-drilldown", { id, asOfDate, search }],
		queryFn: () =>
